...
<script type="text/javascript">
	jQuery(function($) {
		var pathname = window.location.protocol + "//" + window.location.host + "/QnA";
		    ...
		    submitHandler: function(form) {
			    $.post("register", {
					...
					if(!$.trim(data)) {
						...
						$(".registererror").html("User with this email already exists.")
						$("#registerSubmit").val("Sign Up");
					} else {
						console.log(data)
...
<body>
	...
	<p>Sign Up</p>
		...
		<p><input type="text" placeholder="Last Name" id="lname" name="lname" /></p>
		...
		<p><input type="submit" id="registerSubmit" value="Sign Up" /></p>
